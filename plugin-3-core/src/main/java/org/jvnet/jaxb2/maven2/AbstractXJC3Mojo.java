...
public abstract class AbstractXJC3Mojo<O> extends AbstractMojo implements
	 ...
	 * {@link URI}, or in the case of the JAR protocol, "jar" plus the
	 ...
	 * protocol is the scheme portion of a {@link URI}, or in the case
	...
	public void setPluginArtifacts(
			List<Artifact> plugingArtifacts) {
